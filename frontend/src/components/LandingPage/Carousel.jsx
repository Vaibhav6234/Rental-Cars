...
const Carousel = () => {
  ...
  const visible = Array.from({ length: Math.min(VISIBLE, cars.length) }, (_, i) =>
    cars[(current + i) % cars.length]
  )

  return (
    <section className="px-6 py-12 md:px-8 bg-[linear-gradient(180deg,#f8fafc_0%,#eef2ff_100%)]">
