...
const ProfilePage = ({ onLogin }) => {
  ...
  const fetchProfile = async () => {
    try {
      setIsLoading(true)
      const { data } = await axios.get(`${import.meta.env.VITE_API_URL}/api/user/profile`, authHeader)
  ...
  const handleSave = async () => {
    ...
    try {
      setIsSaving(true)
      const { data } = await axios.put(`${import.meta.env.VITE_API_URL}/api/user/profile`, form, authHeader)
      setProfile(data.user)
      setIsEditing(false)
  ...
  const handleAvatarChange = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(`${import.meta.env.VITE_API_URL}/api/user/profile/avatar`, formData, {
        headers: {
